...
| Endings | 3 |
| Tier 2 examine objects | 22 (18 dedicated images; `obj-water-clock` reused across Scenes 1, 3 and 6; Scene 6 "hands" is text-only; Scene 5 "calendar" is an HTML widget) |
