...
/superstes
  ...
  /assets
    /images        // 33 art assets, filenames per superstes-art-prompts.md
      /thumbs      // 400px wall tier, generated by scripts/optimize_images.sh
    /sound         // 14 audio assets, filenames per superstes-sound-design.md
...
See [superstes-sound-design.md](superstes-sound-design.md) §12 for that interface.
