...
assets/images/   art (WebP), filenames per docs/superstes-art-prompts.md
...
rules live in [docs/superstes-art-prompts.md](docs/superstes-art-prompts.md).
...
[docs/superstes-sound-design.md](docs/superstes-sound-design.md) for the full cue list, the three earned
silences, and the toggle.

## The docs

- [docs/superstes-script.md](docs/superstes-script.md) — narrative, scenes, endings,
  theme (source of truth for story).
- [docs/superstes-art-prompts.md](docs/superstes-art-prompts.md) — art direction and asset filenames.
