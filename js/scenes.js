// TESTIS — scene data.
// Narrative content transcribed from docs/the-water-clock-script.md v3 (source of truth).
...
const SCENES = [
  ...
  // ─────────────────────────────────────────────────────────────── SCENE 2
  {
    ...
    openingPlate: {
      image: "assets/char-copernicus-bound.png",
      text: [
  ...
  // ─────────────────────────────────────────────────────────────── SCENE 4
  {
    ...
    closingPlate: {
      image: "assets/char-copernicus-reveal.png",
      text: [
  ...
  // ─────────────────────────────────────────────────────────────── SCENE 5
  {
    ...
    openingPlate: {
      image: "assets/char-player-hands.png",
      text: [
